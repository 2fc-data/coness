...
const MaisonMariaThereza = () => {
  ...
  return(
    <Styled.MaisonMariaThereza>
      ...
      <div className='inner-wrapper'>
        ...
        <div className='boxText'>
          ...
          <div className='descricao'>
            ...
            <p>MAISON MARIA THEREZA traz a força da natureza, aliada à uma arquitetura de excelência arrojada e moderna, com notas de arte, com cada detalhe compondo e trazendo harmonia, equilíbrio e bem estar.</p>
          </div>
        </div>
      </div>
      ...
      <div className='inner-wrapper'>
        <div className='boxText'>
          <div className='titulo'>Tipologia - Planta Baixa Subsolo</div>
        </div>
      </div>

      <div className='inner-wrapper'>
        <div className='boxImg boxImg__tipologia'> 
          <img src="./images/empreendimentos/mmt/tipologia_plantaBaixaSubsolo.png" alt="" width='90%' height='90%' />
        </div>
      </div>
      ...
      <div className='inner-wrapper'>
        <div className='boxText'>
          <div className='titulo'>Tipologia - Planta Baixa Térreo</div>
        </div>
      </div>

      <div className='inner-wrapper'>
        <div className='boxImg'>
          <img src="./images/empreendimentos/mmt/tipologia_plantaBaixaTerreo.png" alt="" />
        </div>
        
        <div className='boxText'>
          <div className='box_pavimento'>
            <img src="./images/empreendimentos/mmt/tipologia_plantaBaixaTerreo_4.png" alt="" />
          </div>

          <div className='box_pavimento'>
            <img src="./images/empreendimentos/mmt/tipologia_plantaBaixaTerreo_3.png" alt="" />
          </div>

          <div className='box_pavimento'>
            <img src="./images/empreendimentos/mmt/tipologia_plantaBaixaTerreo_2.png" alt="" />
          </div>

          <div className='box_pavimento'>
            <img src="./images/empreendimentos/mmt/tipologia_plantaBaixaTerreo_1.png" alt="" />
          </div>

          <div className='box_pavimento'>
            <img src="./images/empreendimentos/mmt/tipologia_plantaBaixaTerreo_0.png" alt="" />
          </div>
        </div>
      </div>
      ...
      <div className='inner-wrapper'>
        <div className='boxImg'>
          <img src="./images/empreendimentos/mmt/tipologia_plantaBaixaPavimentos.png" alt="" />
        </div>
        
        <div className='boxText'>
          <div className='box_pavimento'>
            <img src="./images/empreendimentos/mmt/tipologia_plantaBaixaPavimentos_3.png" alt="" />
          </div>

          <div className='box_pavimento'>
            <img src="./images/empreendimentos/mmt/tipologia_plantaBaixaPavimentos_2.png" alt="" />
          </div>

          <div className='box_pavimento'>
            <img src="./images/empreendimentos/mmt/tipologia_plantaBaixaPavimentos_1.png" alt="" />
          </div>
      ...
      <div className='inner-wrapper'>
        <div className='boxImg boxImg__tipologia'>
          <img src="./images/empreendimentos/mmt/tipologia_5pavimento.png" alt=""  />
        </div>
      </div>
      
      <div className='inner-wrapper'>
        <div className='boxImg boxImg__tipologia'>
          <div className='subTitulo'>Roof Top / Área de lazer</div>
          <img src="./images/empreendimentos/mmt/tipologia_roofTop.png" alt="" width='90%' height='90%' />
        </div>
      </div>
